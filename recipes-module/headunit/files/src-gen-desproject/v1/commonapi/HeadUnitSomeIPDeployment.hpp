...
#ifndef V1_COMMONAPI_Head_Unit_SOMEIP_DEPLOYMENT_HPP_
#define V1_COMMONAPI_Head_Unit_SOMEIP_DEPLOYMENT_HPP_
...
#endif // V1_COMMONAPI_Head_Unit_SOMEIP_DEPLOYMENT_HPP_
